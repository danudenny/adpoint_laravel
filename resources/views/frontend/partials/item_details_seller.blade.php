        ...
        <div class="col-md-6">
            <table class="details-table table">
                <tbody>
                    <tr>
                        <th>{{__('Customer')}}</td>
                        <td>{{ json_decode($query->address)->name }}</td>
                    </tr>
                    <tr>
                        <th>{{__('Email')}}</th>
                        <td>{{ json_decode($query->address)->email }}</td>
                    </tr>
                    <tr>
                        <th>{{__('Address')}}</th>
                        <td>{{ json_decode($query->address)->address }}, {{ json_decode($query->address)->city }}, {{ json_decode($query->address)->country }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
