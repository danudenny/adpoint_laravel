            ...
            <article class="card no-border mt-1">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            <td width="100">
                                <img width="100" src="{{ url(json_decode($product->photos)[0]) }}" class="img-fluid" width="80">
                            </td>
                            <td width="250"> 
                            ...
                            <td align="right">
                                <button onclick="reviewProdocut({{ $od->id }})" class="btn btn-outline-success btn-sm btn-circle"><i class="fa fa-star"></i> Review</button>
